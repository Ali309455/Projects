...
const Navbar = () => {
  ...
  return (
    <nav className='w-full  text-white font-poppins'>
        ...
        <div className='mx-3 flex gap-2 my-1' >
            ...
            <button className="tags flex items-center gap-1 px-3 py-1 rounded-md bg-pink-500 hover:bg-pink-600"><img src="/github.svg" alt="logout" className='invert' width={30} /><a onClick={() => handlelogout()}>Logout</a></button>
        </div>
        </div>
    </nav>
  )
