                  ...
                  <tr key={index} className="border border-pink-700">
                    ...
                    <td className="p-2 text-gray-600  border-pink-400 border-b-2 text-center max-md:text-[0.6rem] text-[clamp(0.6rem,0.495rem_+_0.525vw,1.125rem)]">
                      <div className="flex items-center justify-between max-sm:flex-col">
                        ...
                        <span
                          className="cursor-pointer"
                          onClick={() => copypassword(item.username)}
                        >
                          <lord-icon
                            src="https://cdn.lordicon.com/depeqmsz.json"
                            trigger="hover"
                    ...
                    <td className="p-2 px-3 text-gray-600  border-pink-400 border-b-2 max-md:text-[0.6rem] text-[clamp(0.6rem,0.495rem_+_0.525vw,1.125rem)] max-sm:flex-col">
                      <div className="flex items-center justify-between max-sm:flex-col">
